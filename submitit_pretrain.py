...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    print(user)
    if Path(f"/home/{user}/mae-main/checkpoint/").is_dir():
        p = Path(f"/home/{user}/mae-main/checkpoint/experiments")
...
def main():
    ...
    trainer = Trainer(args)
    trainer()
    # trainer.train()  # Start the training directly
    
    # Optionally, you can print some information after training
